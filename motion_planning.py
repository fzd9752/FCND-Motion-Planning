...
from planning_utils import a_star, heuristic, create_grid, load_csv, path_prune
...
class MotionPlanning(Drone):
    ...
    def __init__(self, connection, global_goal_position=np.array([-122.39772557, 37.7935089, 5.0], dtype='Float64')):
    ...
    def plan_path(self):
        ...
        ## local_position (north, east, down)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--goal_lon', type=str, default='-122.39772557', help="Goal longitude")
    parser.add_argument('--goal_lat', type=str, default='37.7935089', help="Goal latitude")
